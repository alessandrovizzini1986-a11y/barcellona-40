...
- **Due badge `da_verificare` rimasti da versioni vecchie, tolti oggi.** Il Rooftop Garden (`f14`) ce l'aveva da quando il venue non aveva coordinate: sono state confermate via Google Places qualche giro fa e il badge era rimasto lì a dire il falso. Il pomeriggio di sabato (`s7`) ce l'aveva per gli eventi techno "NON confermati": quella verifica è stata chiusa per decisione — non ci interessa cosa suona — quindi la tappa è diventata "Pomeriggio libero" e basta, col badge `stimato`.
...
- **BO&MIE: chiusa.** La prima foto era arrivata corrotta (mancava il 31% del file e l'immagine non si decodificava); la seconda, un'altra inquadratura, è arrivata intera. La tappa è nel sito con tutto il resto: venue verificato, 09:55 per mezz'ora, 1.291 m dall'appartamento e 162 m alla Sagrada.
- **Il link Maps della mattina di sabato non passa da BO&MIE.** È uno degli otto percorsi verificati a mano e non si rigenera: va dall'appartamento dritto alla Sagrada. BO&MIE sta 162 m prima dell'ingresso, praticamente sulla stessa strada, e la differenza fra il percorso del link e quello vero è di circa 140 m. Il totale sul pulsante (2,0 km · 25 min) è invece quello vero, perché lo somma dalle nostre tappe, BO&MIE compresa.
- **Forn Oriol: verificato via Google Places.** Carrer de Nàpols 113 (41.3951541, 2.1794631), sabato 6:30-21:00, domenica 8:00-14:30, 3,4 su 169 recensioni, tel +34 938 74 77 54, 69 m dall'appartamento. È il piano B se Teixidó chiude: non è una tappa, quindi vive come riga di dettaglio, non come venue.
- **Bodega Biarritz, fasce di prezzo: non esistono online.** Il locale non ha sito (i domini plausibili non rispondono) e i prezzi non sono pubblicati da nessuna parte: **si scoprono sul posto**, all'ingresso. L'unico dato reale è una recensione — fascia bassa con antipasto, 8 tapas, due shot e una bottiglia, poco meno di 70 euro in due, sui 30-35 a testa — e sta fra i dettagli **stimati** della tappa, non fra i verificati. Non è una voce aperta: è una cosa che non si può sapere prima.
