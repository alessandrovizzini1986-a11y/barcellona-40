...
- **Tiro deterministico**: il ritardo di reazione del portiere è 0,26–0,32 s (facile), 0,20–0,28 s (normale), 0,13–0,18 s (Boss); il prompt chiedeva 180–320 ms con il Boss più basso. La finestra dell'animazione del tuffo è riscalata perché l'allungo finisca 0,25 s dopo l'impatto, e il corpo arrivi nella zona esattamente all'impatto: numeri scelti perché il tuffo sia sempre leggibile, **da provare sul telefono**. Il volo libero è campionato a 1/120 s per 3,2 s al massimo.
