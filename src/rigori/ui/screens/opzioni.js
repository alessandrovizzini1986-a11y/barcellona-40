...
export function opzioni(ui, settings, { onChange, onReset }) {
  return new Promise((resolve) => {
    ...
    el.innerHTML = `<div class="rg-panel" role="dialog" aria-modal="true" aria-label="Opzioni">
      ...
      ${sw('audio', 'Effetti sonori')}${sw('music', 'Musica')}${sw('vibration', 'Vibrazione')}${sw('reduceFx', 'Riduci flash e shake')}${sw('timing', 'Barra del tempismo')}${sw('skipReplay', 'Salta replay automaticamente')}
